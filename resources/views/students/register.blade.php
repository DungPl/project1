...
<head>
    ...
    <!-- Icons font CSS-->
    <link href="{{ asset('vendor1/mdi-font/css/material-design-iconic-font.min.css') }}" rel="stylesheet"
        media="all">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('student.register') }}">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="firstname"
                                        @error('firstname') is-invalid @enderror value="{{ old('firstname') }}"
                                        required>
                                    @error('firstname')
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="text" name="lastname"
                                        @error('lastname') is-invalid @enderror value="{{ old('lastname') }}" required>
                                    @error('lastname')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="input-group">
                            ...
                            <div class="rs-select2 js-select-simple select--no-search">
                                <input class="input--style-4" type="text" name="password_confirmation"
